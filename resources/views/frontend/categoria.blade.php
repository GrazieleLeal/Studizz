    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="{{route('opcaoQuiz')}}" class="blog-post-title categoria">Biologia</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="#" class="blog-post-title categoria">Desenvolvimento Web</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="#" class="blog-post-title categoria">Desenvolvimento Móvel</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="#" class="blog-post-title categoria">Banco de dados</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="#" class="blog-post-title categoria">Matemática</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
                ...
                <a href="#" class="blog-post-title categoria">Português</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="blog-post-card wow fadeInUp"  style="margin-top:10%;">
