                            ...
                            <form class="pt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="password" type="password" class="form-control form-control-lg border-left-0 @error('password') is-invalid @enderror" name="password" placeholder="Senha" required autocomplete="current-password">
                                ...
                                <div class="text-center mt-4 font-weight-light">
                                    ...
                                    @if (Route::has('register'))
                                        <a class="text-primary" href="{{ route('register') }}">{{ __('Crie') }}</a>
                                    @endif
                                </div>
                            </form>
                        </div>
